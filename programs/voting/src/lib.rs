...
mod voting {
    use super::*;
    pub fn initialize(ctx: Context<InitializePoll>, _poll_id: u64,name:String,description:String,start_time:u64,end_time:u64) -> Result<()> {
    ...
    pub fn initialize_candiate(ctx:Context<InitializeCandiate>,_candidate:String,name:String) -> Result<()>{
          let poll_account = &mut ctx.accounts.poll_account;
